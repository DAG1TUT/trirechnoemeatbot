...
SELLERS = [
    "Гаджимурадова Нефизат Алимурадовна",
    "Штефаньо Инна Александровна",
    "Сагидова Джамиле Аслановна",
    "Конева Анастасия Владимировна",
    "Благова Наталья Валерьевна",
    "Русина Наталия Владимировна",
    "Михайлова Екатерина Вадимовна",
    "Мирзоева Ирина",
    "Двоник Наталья",
    "Шаляпина Оксана",
    "Алиева Кистаман",
    "Серебрянникова Татьяна",
    "Зелинская Людмила",
    "Гриценко Валентина",
    "Косова Людмила",
    "Кошковар Татьяна",
